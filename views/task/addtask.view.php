                    ...
                    <div class="add-client bg-white rounded">
                        ...
                        <div class="row p-20">
                            ...
                            <div class="col-3">
                                <div class="form-group my-3">
                                    <label class="f-14 text-dark-grey mb-12" data-label="true"
                                        for="task_start_date"><?=G_START_DATE;?>
                                        <sup class="f-14 mr-1">*</sup>
                                    </label>
                            ...
                            <div class="col-3">
                                <div class="form-group my-3">
                                    <label class="f-14 text-dark-grey mb-12" data-label=""
                                        for="selectAssignee"><?=G_ASSIGNED_TO;?><sup
                            ...
                            <div class="col-3">
                                ...
                                <div class="form-group mb-0">
                                    <select class="selectpicker form-control height-35 f-14" name="priority"
                                        id="priority">
                                        <option
                                            data-content="<i class='bi bi-circle-fill  mr-2'  style='color:#f1c40f'></i>  <?=G_PRIORITY_LOW;?>"
                                            value="1">
                                            <?=G_PRIORITY_LOW;?>
                                        </option>
                                        <option
                                            data-content="<i class='bi bi-circle-fill  mr-2'  style='color:#e67e22'></i>   <?=G_PRIORITY_MEDIUM;?>"
                                            value="2">
                                            <?=G_PRIORITY_MEDIUM;?>
                                        </option>
                                        <option
                                            data-content="<i class='bi bi-circle-fill  mr-2'  style='color:#e74c3c'></i>  <?=G_PRIORITY_HIGH;?>"
                                            value="3">
                                            <?=G_PRIORITY_HIGH;?>
                                        </option>
                                    </select>
