								...
								<div class="card-body">
									...
									<div class="row p-2 m-1">
										...
										<div class="col-md-12 mt-1">
											<span
												class='badge badge-pill  badge-info  p-2 m-1'><?=$employee['designation_name']?></span>
										</div>
									</div>
									<div class="row p-2 m-1">
										<?=G_DEPARTMENT;?>(s): <br>
										<div class="col-md-12 mt-1">
											<?php foreach($departmentEmployees as $departmentEmployee) { ?>
											<span class="badge badge-pill badge-primary p-2 m-1">
												<?=$departmentEmployee['team_name'];?>
											</span>
											<?php } ?>
										</div>
									</div>
									...
									<div class="row p-2 m-1">
										...
										<div class="col-md-12 mt-1">
											<span
												class='badge badge-pill  badge-info  p-2 m-1'><?=G_CLIENT;?></span>
										</div>
									</div>
