                        ...
                        <div class="row p-20">
                            <div class="col-lg-9 col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <label class="f-14 text-dark-grey mb-12 mt-3" data-label="true" for="password">
                                            <?=G_PASSWORD;?>
                                            <sup class="f-14 mr-1">*</sup>
                                        </label>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                    <img src="<?=ROOT?>/images/avatar.png"
                                        class="img-fluid rounded-circle" width="90" height="90">
                                    <?php endif; ?>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="form-group mb-0">
                                    <select name="country_id" class="form-control selectpicker height-35 f-14"
                                        ...
                                        <option
                                            value="<?=$country['id'];?>"
                                            <?php if($country['id'] == $employee['country_id']) {
                                                echo "selected";
                                            } ?>>
                                            <?=$country['nicename'];?>
                                        </option>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="form-group my-3" style="position: relative;">
                                    ...
                                    <input type="date" class="form-control  date-picker height-35 f-14"
                                        ...
                                        name="date_of_birth" id="date_of_birth" autocomplete="off">
                        ...
                        <div class="row p-20">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check-inline custom-control custom-radio mt-2 mr-3">
                                            <input type="radio" value="enable" class="custom-control-input"
                                                id="login-yes" name="login"
                                                <?=$employee['login'] == "enable" ? 'checked=""':'';?>
                                            autocomplete="off">
                                        ...
                                        <div class="form-check-inline custom-control custom-radio mt-2 mr-3">
                                            <input type="radio" value="disable" class="custom-control-input"
                                                id="login-no" name="login"
                                                <?=$employee['login'] == "disable" ? 'checked=""':'';?>
                                            autocomplete="off">
                                            <label class="custom-control-label pt-1 cursor-pointer"
                            ...
                            <div class="col-lg-3 col-md-6">
                                <label class="f-14 text-dark-grey mb-12 my-3" data-label=""
                                    for="slack_username"><?=G_SLACK_USERNAME;?>
                                </label>
                                <div class="input-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group my-3">
                                    ...
                                    <input type="text" class="form-control height-35 f-14"
                                        ...
                                        name="skills" id="tags" autocomplete="off">
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        var
            departments = <?=json_encode($teams);?> ;
        $('#employee_department').selectpicker('val', departments);
