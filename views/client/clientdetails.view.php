                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                                    ...
                                                    <a class="dropdown-item "
                                                        href="<?=ROOT?>/client/<?=$id?>?edit"><?=G_EDIT;?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
                <div class="card bg-white border-0 b-shadow-4">
                    <div class="card-header bg-white border-0 text-capitalize d-flex justify-content-between p-20">
                        <h4 class="f-18 f-w-500 mb-0"><?=G_PROFILE;?>
                        </h4>
                    </div>
                    <div class="card-body ">
                            ...
                            <div id="table-actions" class="d-flex align-items-center">
                                ...
                                <button id="department-setting-add" type="button"
                                    ...
                                    data-target="#myModal2"><i
                                        class="bi bi-plus-lg mr-2"></i><?=G_ADD;?></button>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <?php if($note['type'] == 1): ?>
                                                        <span
                                                            class="badge badge-pill badge-primary"><?=G_PRIVATE;?></span>
                                                        <?php else: ?>
                                                        <span
                                                            class="badge badge-pill badge-success"><?=G_PUBLIC;?></span>
                                                        <?php endif; ?>
