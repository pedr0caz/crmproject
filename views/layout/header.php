    ...
    <header class="main-header clearfix bg-white" id="header">
        ...
        <div class="page-header-right float-right d-flex align-items-center">
            <ul>
                ...
                <li>
                    <div class="d-flex align-items-center">
                        <a href="javascript:;" class="d-block header-icon-box open-search">
                            <svg class="svg-inline--fa fa-search fa-w-16 f-16 text-dark-grey" aria-hidden="true"
                            ...
                            </svg><!-- <i class="fa fa-search f-16 text-dark-grey"></i> Font Awesome fontawesome.com -->
                        </a>
                    </div>
                </li>
                <!-- SEARCH END -->
                ...
                <li>
                    <div class="d-flex align-items-center">
                        <a href="http://localhost/script/public/account/sticky-notes"
                            class="d-block header-icon-box openRightModal">
                            <svg class="svg-inline--fa fa-sticky-note fa-w-14 f-16 text-dark-grey" aria-hidden="true"
                                focusable="false" data-prefix="fa" data-icon="sticky-note" role="img"
                            ...
                            <!-- <i class="fa fa-sticky-note f-16 text-dark-grey"></i> Font Awesome fontawesome.com -->
                        </a>
                    </div>
                </li>
                <!-- Sticky Note END -->
                ...
                <li>
                    <div class="add_box dropdown">
                        <a class="d-block dropdown-toggle header-icon-box" type="link" id="show-active-timer"
                            ...
                            <svg class="svg-inline--fa fa-clock fa-w-16 f-16 text-dark-grey" aria-hidden="true"
                                focusable="false" data-prefix="fa" data-icon="clock" role="img"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                <path fill="currentColor"
                                    d="M256,8C119,8,8,119,8,256S119,504,256,504,504,393,504,256,393,8,256,8Zm92.49,313h0l-20,25a16,16,0,0,1-22.49,2.5h0l-67-49.72a40,40,0,0,1-15-31.23V112a16,16,0,0,1,16-16h32a16,16,0,0,1,16,16V256l58,42.5A16,16,0,0,1,348.49,321Z">
                                </path>
                            </svg><!-- <i class="fa fa-clock f-16 text-dark-grey"></i> Font Awesome fontawesome.com -->
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right" id="active-timer-list"
                            ...
                            <a class="dropdown-item text-primary f-w-500" href="javascript:;" id="start-timer-modal">
                                <svg class="svg-inline--fa fa-play fa-w-14 mr-2" aria-hidden="true" focusable="false"
                                    data-prefix="fa" data-icon="play" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z">
                                    </path>
                                </svg><!-- <i class="fa fa-play mr-2"></i> Font Awesome fontawesome.com -->
                                Start Timer </a>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="add_box dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink" tabindex="0">
                            <a class="dropdown-item f-14 text-dark openRightModal"
                                href="http://localhost/script/public/account/projects/create">
                            ...
                            <a class="dropdown-item f-14 text-dark openRightModal"
                                href="http://localhost/script/public/account/tasks/create">
                                <svg class="svg-inline--fa fa-plus fa-w-14 f-w-500 mr-2 f-11" aria-hidden="true"
                                    focusable="false" data-prefix="fa" data-icon="plus" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                            ...
                            <a class="dropdown-item f-14 text-dark openRightModal"
                                href="http://localhost/script/public/account/clients/create">
                                <svg class="svg-inline--fa fa-plus fa-w-14 f-w-500 mr-2 f-11" aria-hidden="true"
                                    focusable="false" data-prefix="fa" data-icon="plus" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                            ...
                            <a class="dropdown-item f-14 text-dark openRightModal"
                                href="http://localhost/script/public/account/employees/create">
                                <svg class="svg-inline--fa fa-plus fa-w-14 f-w-500 mr-2 f-11" aria-hidden="true"
                                    focusable="false" data-prefix="fa" data-icon="plus" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                            ...
                            <a class="dropdown-item f-14 text-dark openRightModal"
                                href="http://localhost/script/public/account/payments/create">
                                <svg class="svg-inline--fa fa-plus fa-w-14 f-w-500 mr-2 f-11" aria-hidden="true"
                                    focusable="false" data-prefix="fa" data-icon="plus" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                            ...
                            <a class="dropdown-item f-14 text-dark openRightModal"
                                href="http://localhost/script/public/account/tickets/create">
                                <svg class="svg-inline--fa fa-plus fa-w-14 f-w-500 mr-2 f-11" aria-hidden="true"
                                    focusable="false" data-prefix="fa" data-icon="plus" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                    <path fill="currentColor"
